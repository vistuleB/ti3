...
fn our_pipeline() -> List(infra.Desugarer) {
  [
    ...
    [
      ...
      dn.associate_counter_by_prepending_incrementing_attribute([#("Definition", "DefinitionCounter"), #("Beobachtung", "DefinitionCounter")]),
      ...
      dn.group_consecutive_children_avoiding(
        #(
          ...
          [
            ...
            "Sub", "SubTitle", "Definition", "Beobachtung",
